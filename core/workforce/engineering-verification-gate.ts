  ...
  verify(
    ...
    for (
      ...
      evidence.push({
        ...
        summary:
          failedProjectCommand
            ? `Verification suite failed at command ${failedProjectCommand.id}; no criterion may be certified until the complete governed verification run passes.`
